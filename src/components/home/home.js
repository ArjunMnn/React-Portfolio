    ...
    <div>
      ...
      <section id="home" className="section">
        ...
        <div className="hero-content">
          <div className="hero-heading2">Arjun Menon</div>
          ...
          <div className="row">
            <div className="col-lg-7">
              <div className="hero-name">
                <h1>
                  Hi, I am
                  <span className="blue-txt"> Arjun Menon</span>
                </h1>
                <h2
                  id="glitchy"
                  data-tip="true"
                ...
                <div>
                  <div class="ml-2 hero-lang-icons">
                    <svg
                      width="25"
                      height="25"
                      viewBox="0 0 256 256"
            ...
            <div className="col-lg-5 hero-big-svg">
              <svg
